...
export const Layout = ({ children, className, ...props }: LayoutProps) => {
  ...
  return (
    <div
      className={cx(
        "relative flex flex-col flex-nowrap justify-between min-h-screen w-screen",
        className,
      )}
      {...props}
    >
      {topBanner}
      <div className="relative flex flex-col grow items-center justify-between w-screen">
        <div className="relative flex flex-col grow items-center w-screen">
          {header}
          {hero}
          <div
            className={cx(
              "relative grow-0 w-full",
          ...
          >
            ...
            <main
              className={cx(
                "relative grow lg:min-w-sz-768 xl:min-w-[calc(2*var(--sz-208)+var(--sz-768))] 2xl:min-w-[calc(2*var(--sz-208)+var(--sz-768))] 3xl:min-w-[calc(2*var(--sz-208)+var(--sz-768))] flex flex-nowrap flex-row justify-center",
              )}
            >
              {leadingSidebar}
              {content}
